# Experiment Report: 20260323_092630_seed_sweep_seed_77
...
## 实验任务单
- run_id: `20260323_092630_seed_sweep_seed_77`
...
## 运行过程摘要
- 创建时间: 2026-03-23T01:27:24.606640+00:00
- Run root: `runs/20260323_092630_seed_sweep_seed_77`
- 日志路径: `experiments/logs/20260323_092630_seed_sweep_seed_77.log`
- 总耗时(秒): 0.0
- Warning 数: 8
- Error 数: 0
- 是否全部成功: 是
...
- 与上一轮相比: 上一轮 `20260323_092536_seed_sweep_seed_42` 的最优模型是 `affect_state_forecaster`，本轮最佳 MAE 变化 -0.0047。
...
## 图表解读
- Model metrics: `experiments/figures/20260323_092630_seed_sweep_seed_77_model_metrics.png`
  该图用于比较模型整体误差，当前 MAE 最优模型是 `affect_state_forecaster`。
- Event errors: `experiments/figures/20260323_092630_seed_sweep_seed_77_event_errors.png`
  该图用于查看不同事件上的误差波动，帮助判断 cross-event 稳定性。
- Ratio trends: `experiments/figures/20260323_092630_seed_sweep_seed_77_ratio_trends.png`
