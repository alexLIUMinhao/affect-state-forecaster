# Experiment Report: 20260319_173001_cross_event_ottawashooting
...
## 实验任务单
- run_id: `20260319_173001_cross_event_ottawashooting`
- 成功标准: affect_state_forecaster 在 held-out event 上保持与主实验一致的领先趋势。
- 失败标准: 若 held-out event 掉点显著，则后续优先做泛化与正则化。
- 数据集: /tmp/pheme_cross_event_nzz5m343/ottawashooting_train.jsonl
...
## 运行过程摘要
- 创建时间: 2026-03-19T09:30:33.253535+00:00
- Run root: `runs/20260319_173001_cross_event_ottawashooting`
- 日志路径: `experiments/logs/20260319_173001_cross_event_ottawashooting.log`
- 总耗时(秒): 0.0
- Warning 数: 0
- Error 数: 0
- 是否全部成功: 是
...
- 与上一轮相比: 上一轮 `20260319_172927_cross_event_germanwings_crash` 的最优模型是 `structure_baseline`，本轮最佳 MAE 变化 0.013。
...
## 图表解读
- Model metrics: `experiments/figures/20260319_173001_cross_event_ottawashooting_model_metrics.png`
  该图用于比较模型整体误差，当前 MAE 最优模型是 `temporal_baseline`。
- Event errors: `experiments/figures/20260319_173001_cross_event_ottawashooting_event_errors.png`
  该图用于查看不同事件上的误差波动，帮助判断 cross-event 稳定性。
- Ratio trends: `experiments/figures/20260319_173001_cross_event_ottawashooting_ratio_trends.png`
