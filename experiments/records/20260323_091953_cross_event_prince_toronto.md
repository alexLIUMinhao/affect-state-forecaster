# Experiment Report: 20260323_091953_cross_event_prince_toronto
...
## 实验任务单
- run_id: `20260323_091953_cross_event_prince_toronto`
- 成功标准: affect_state_forecaster 在 held-out event 上保持与主实验一致的领先趋势。
- 失败标准: 若 held-out event 掉点显著，则后续优先做泛化与正则化。
- 数据集: /tmp/pheme_cross_event_8j60zwfh/prince-toronto_train.jsonl
...
## 运行过程摘要
- 创建时间: 2026-03-23T01:20:50.145325+00:00
- Run root: `runs/20260323_091953_cross_event_prince_toronto`
- 日志路径: `experiments/logs/20260323_091953_cross_event_prince_toronto.log`
- 总耗时(秒): 0.0
- Warning 数: 8
- Error 数: 0
- 是否全部成功: 是
...
- 与上一轮相比: 上一轮 `20260323_091856_cross_event_ottawashooting` 的最优模型是 `thread_transformer_baseline`，本轮最佳 MAE 变化 -0.0188。
...
## 图表解读
- Model metrics: `experiments/figures/20260323_091953_cross_event_prince_toronto_model_metrics.png`
  该图用于比较模型整体误差，当前 MAE 最优模型是 `patchtst_baseline`。
- Event errors: `experiments/figures/20260323_091953_cross_event_prince_toronto_event_errors.png`
  该图用于查看不同事件上的误差波动，帮助判断 cross-event 稳定性。
- Ratio trends: `experiments/figures/20260323_091953_cross_event_prince_toronto_ratio_trends.png`
