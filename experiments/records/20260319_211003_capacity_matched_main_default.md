# Experiment Report: 20260319_211003_capacity_matched_main_default
...
## 实验任务单
- run_id: `20260319_211003_capacity_matched_main_default`
...
- 特殊设置: capacity_group=default; target_model=structure_baseline; target_param_tolerance=0.05

## 运行过程摘要
- 创建时间: 2026-03-19T13:10:36.302157+00:00
- Run root: `runs/20260319_211003_capacity_matched_main_default`
- 日志路径: `experiments/logs/20260319_211003_capacity_matched_main_default.log`
- 总耗时(秒): 0.0
- Warning 数: 4
- Error 数: 0
- 是否全部成功: 是
...
## 图表解读
- Model metrics: `experiments/figures/20260319_211003_capacity_matched_main_default_model_metrics.png`
  该图用于比较模型整体误差，当前 MAE 最优模型是 `affect_state_forecaster`。
- Event errors: `experiments/figures/20260319_211003_capacity_matched_main_default_event_errors.png`
  该图用于查看不同事件上的误差波动，帮助判断 cross-event 稳定性。
- Ratio trends: `experiments/figures/20260319_211003_capacity_matched_main_default_ratio_trends.png`
