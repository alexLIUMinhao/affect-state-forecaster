# Experiment Report: 20260323_091235_ratio_sweep_ratio_30
...
## 实验任务单
- run_id: `20260323_091235_ratio_sweep_ratio_30`
- 成功标准: affect_state_forecaster 在主要回归指标上稳定优于文本基线，并最好保持最优。
- 失败标准: 如果 affect_state_forecaster 不能稳定领先，则转入诊断与消融实验。
- 数据集: /home/alexmhliu/affect-state-forecaster/data/processed/pheme_forecast_ratio_30_train.jsonl
...
## 运行过程摘要
- 创建时间: 2026-03-23T01:13:26.390255+00:00
- Run root: `runs/20260323_091235_ratio_sweep_ratio_30`
- 日志路径: `experiments/logs/20260323_091235_ratio_sweep_ratio_30.log`
- 总耗时(秒): 0.0
- Warning 数: 8
- Error 数: 0
- 是否全部成功: 是
...
- 与上一轮相比: 上一轮 `20260323_091059_main_plus_topconf` 的最优模型是 `affect_state_forecaster`，本轮最佳 MAE 变化 -0.0237。
...
## 图表解读
- Model metrics: `experiments/figures/20260323_091235_ratio_sweep_ratio_30_model_metrics.png`
  该图用于比较模型整体误差，当前 MAE 最优模型是 `thread_transformer_baseline`。
- Event errors: `experiments/figures/20260323_091235_ratio_sweep_ratio_30_event_errors.png`
  该图用于查看不同事件上的误差波动，帮助判断 cross-event 稳定性。
- Ratio trends: `experiments/figures/20260323_091235_ratio_sweep_ratio_30_ratio_trends.png`
